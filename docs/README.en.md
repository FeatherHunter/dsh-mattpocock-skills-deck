...
# Pin to latest for extra stability (currently 1.7.23):
# dsh plugin --profile desktop add dsh-mattpocock-skills-deck@1.7.23 --registry https://registry.npmjs.org
...
dsh plugin --profile web add dsh-mattpocock-skills-deck@1.7.23 --registry https://registry.npmjs.org
