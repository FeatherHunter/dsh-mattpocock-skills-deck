 ...
 */
    export const L_WORD = {
      zh: {
        ...
        'more.desc.im': '扫码或填凭据就把飞书、微信等 9 路聊天机器人接进来',
        'more.desc.uidebug': '让 AI 在真实浏览器里帮你看界面、点按钮、拖组件',
      ...
      en: {
        ...
        'more.desc.im': 'Bring in 9 chat bots such as Feishu and WeChat by scanning a code or filling in credentials',
        'more.desc.uidebug': 'Let AI see pages, click buttons and drag widgets in a real browser for you',
