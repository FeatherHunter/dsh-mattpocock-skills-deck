 ...
 */
    export const L_PANEL = {
      zh: {
        ...
        'panel.closeTitle': '关闭面板', 'panel.closeDetailTitle': '关闭详情', 'panel.openUnavailable': '面板没打开：宿主现在没有提供 DSH 右侧边栏的控制器，面板暂时没有落点。',
      ...
      en: {
        ...
        'panel.closeTitle': 'Close panel', 'panel.closeDetailTitle': 'Close details', 'panel.openUnavailable': 'The panel did not open: the host is not offering its right-sidebar controller right now, so there is nowhere to put the panel.',
        ...
        'panel.repoLoading': 'Reading repository info…',
