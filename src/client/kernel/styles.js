 ...
 */
    export const STYLE_TEXT = [
      ...
      '.dsws-note{position:absolute;left:14px;bottom:14px;top:auto;right:auto;padding:6px 12px;border-radius:6px;background:light-dark(#f6f8fa,#22252c);border:1px solid light-dark(#e5e7eb,#2a2d35);color:light-dark(#0f1115,#e6edf3);color-scheme:light dark;font-size:12px;z-index:10001;box-shadow:0 4px 20px rgba(0,0,0,.4)}',
