 ...
 */
    export const L = {
      zh: {
        ...
        'list.tagsCollapseTitle': '收起标签 · 仅显示前 4 个',
        ...
        'map.subClosed': '已关闭',
        'map.executeTitle': '注入开始提示词 · 从第一性原理推进该地图',
        'map.doneTitle': '注入收尾确认 · 汇总子票并归档地图',
        'map.inspectTitle': '注入修复提示词 · 检测空地图并补全 Destination',
        ...
        'tip.desc': '完整描述：{desc}',
        'tip.text': '完整内容：{text}',
        'tip.diagnose': '诊断 · 生成分流提示并注入输入框',
        'tip.fix': '修复 · 生成 bug 修复提示并注入',
        'tip.discuss': '讨论 · 注入 grilling 讨论提示，梳理开放问题',
        'tip.research': '研究 · 注入 research 调研提示，沉淀为文档',
        'tip.prototype': '原型 · 注入 prototype 验证提示，快速验证方案',
        'tip.execute': '执行 · 注入开始提示，从头推进任务',
        'tip.newSession': '在新会话打开 · 继承工作区并推进 #{n}',
        'tip.newSessionGeneric': '在新会话打开 · 继承工作区并推进',
        'tip.collapseTags': '收起标签 · 仅显示前 4 个',
        'tip.refreshWs': '刷新 · 重新拉取后端绑定与选中态',
        'tip.copyLink': '复制链接 · 复制 issue 链接到剪贴板',
        'tip.openInTracker': '在当前 Tracker 打开 #{n} · 跳转到原票',
        'tip.sendComment': '发送评论 · 提交到当前 issue，支持 Markdown',
        'tip.sendingComment': '发送中 · 正在提交评论',
      ...
      en: {
        ...
        'list.tagsCollapseTitle': 'Collapse labels · show first 4 only',
        ...
        'map.executeTitle': 'Inject start prompt · advance the map from first principles',
        'map.doneTitle': 'Inject wrap-up confirmation · summarize children and archive',
        'map.inspectTitle': 'Inject repair prompt · detect empty map and fill Destination',
        ...
        'tip.diagnose': 'Diagnose · generate triage prompt and inject',
        'tip.fix': 'Fix · generate bug-fix prompt and inject',
        'tip.discuss': 'Discuss · inject grilling prompt to clarify open questions',
        'tip.research': 'Research · inject research prompt and write to docs',
        'tip.prototype': 'Prototype · inject prototype prompt for quick validation',
        'tip.execute': 'Execute · inject start prompt and advance from first principles',
        'tip.newSession': 'Open in new session · carry workspace and advance #{n}',
        'tip.newSessionGeneric': 'Open in new session · carry workspace and advance',
        'tip.collapseTags': 'Collapse labels · show first 4 only',
        'tip.refreshWs': 'Refresh · refetch backend bindings and selections',
        'tip.copyLink': 'Copy link · copy issue link to clipboard',
        'tip.openInTracker': 'Open #{n} in tracker · jump to original ticket',
        'tip.sendComment': 'Send comment · submit to current issue (Markdown supported)',
        'tip.sendingComment': 'Sending · submitting comment',
