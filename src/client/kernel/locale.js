 ...
 */
    export const L = {
      ...
      en: {
        ...
        'setup.markdown.paletteNote': 'Add a label palette table to `docs/agents/triage-labels.md`, per these rules: add a `Color` column (hex value, e.g. `#8b5cf6`) on the left of the existing three columns (mattpocock role / our tracker label / meaning), one row per label; pre-filled values for this repo (one per line, editable):\nwayfinder:map=#8b5cf6\nwayfinder:research=#0ea5e9\nwayfinder:prototype=#f59e0b\nwayfinder:grilling=#9d7cd8\nwayfinder:task=#10b981\nbug=#d73a4a\nneeds-triage=#fbca04\nneeds-info=#5319e7\nready-for-agent=#0e8a16\nready-for-human=#b60205\nwontfix=#ffffff\ncustom labels get a new row there; if the table already exists, verify and fill gaps. To change a color, edit the Color value of the matching row.',
