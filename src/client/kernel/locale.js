 ...
 */
    export const L = {
      zh: {
        ...
        'switch.criHintFallback': '请检查 git / gh / gh auth 后重试',
        ...
        'panel.labelsStepDesc': '仓库已建，但 GitHub 标签未全。点击“注入补全指引”后回车让 AI 执行 gh label create 补齐（Markdown 请跳过）。',
      ...
      en: {
        ...
        'switch.criHintFallback': 'Please check git / gh / gh auth and retry',
        ...
        'panel.labelsStepDesc': 'Repo created but GitHub labels are incomplete. Click “Inject completion guide” then press Enter to let the AI run gh label create (skip for Markdown).',
