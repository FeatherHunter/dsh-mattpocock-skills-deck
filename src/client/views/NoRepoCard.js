      ...
      if (isChainRepoFail && repoCreateChainNoRepo && chainSnapForNoRepo && chainSnapForNoRepo.currentIndex!=null) {
        ...
        try{
          const disp = (typeof createActionDispatcher==='function') ? createActionDispatcher({
            ...
            tr: tr,
            resolvePrompt: function(id,pa){ try{ if(id==='setupRun'){ if(typeof injectSetupDecision!=='function') return (typeof setupRunPrompt==='function')?setupRunPrompt(st):''; return (injectSetupDecision(st,undefined,{injectNow:false})==='setup'&&typeof setupRunPrompt==='function')?setupRunPrompt(st):'' } return promptTextFor(st,id,pa)}catch(e){ return '' } }
          }) : null
          if (disp) {
