...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    exports.apply = function (ctx) {
      ...
      // v2（#1 BUG3 补强）：BUG 7 字段空白 body —— 跟在 BODY_FORMAT 之后作为真正的模板末尾输入位
      ...
      const makeStore = () => ({
        ...
        skillsOpen: false, skillHover: null, skillTip: null, handoffReady: false, bugMenuOpen: false, bugMenuHover: false, expTags: {}, subs: [],
      })
