...
console.log('日志计数门禁（#494/#498/#499/#548/#606/#618/#635/#652/#655/#663/#66/#67/#685/#690/#706/#707/#714/#710/#708/#709：常驻 37、按需 42、自监控 5、总数 84，与附录修订版字面一致）')
...
if (appendix) {
  check(appendix.includes('常驻 37 条、按需 42 条、自监控 5 条、总数 84 条'), '附录 counts 字面为常驻 37 条、按需 42 条、自监控 5 条、总数 84 条')
  check(appendix.includes('1、3、4、5、6、7、8、9、10、13、14、16、20、21、26、27、28、31、32、33、36、38、39、40、41、42、51、55、57、60、65、68、69、70、74、80、83'), '附录常驻编号清单 37 个（不含已退役的 22、34、35，不含 45；#498 增补 51、55，#548 增补 57，#618 增补 60，#663 增补 65，#685 增补 68，#683 增补 69、70，#690 增补 74；2026-09-23 #714 增补 80 sessionTickets.chain，号位避让 #707 的 78、79；2026-09-25 #709 登记收口增补 83 chain.backoff）')
...
// 三、总数：已知事件恰为 84 个（常驻 37 加按需 42 加自监控 5），退役的不计入。
{
  ...
  check(RESIDENT.length === 37 && ONDEMAND.length === 42 && SELFMON.length === 5 && known.length === 84, '清单总数 84（常驻 37、按需 42、自监控 5）')
  check(missing.length === 0, '84 个事件全部落点无缺口' + (missing.length ? ' —— 缺口：' + missing.join('、') : '（命中 ' + hitKnown.length + ' 个）'))
}
