...
console.log('日志计数门禁（#494/#498/#499/#548/#606/#618/#635/#652/#655/#663/#66/#67/#685/#690/#706/#707/#714/#710/#708/#709/#724/#727：常驻 38、按需 43、自监控 5、总数 86，与附录修订版字面一致）')
...
if (appendix) {
  check(appendix.includes('常驻 38 条、按需 43 条、自监控 5 条、总数 86 条'), '附录 counts 字面为常驻 38 条、按需 43 条、自监控 5 条、总数 86 条')
  ...
  check(appendix.includes('2、11、12、15、17、18、19、23、24、25、29、30、37、43、44、45、52、53、54、56、58、59、61、62、63、64、66、67、71、72、73、75、76、77、78、79、81、82、84、85、86、87、89'), '附录按需编号清单 43 个（不含已退役的 8、22、34、35 等；含 45；#498 增补 52、53、54、56；#606 增补 58、59；#618 增补 61；#635 增补 62；#652 增补 63；#655 增补 64；2026-09-21 增补 66、67；#683 增补 71、72、73；2026-09-23 #706 第二批增补 75、76、77；#707 第三批增补 78 attention.report、79 attention.sweep；#710 第二批增补 81 write.event；#708 第三批增补 82 refresh.patch；2026-09-25 #709 登记收口增补 84 chain.cache.write、85 chain.event、86 naming.guard.event、87 chain.preflight.reuse；2026-09-27 #727 增补 89 snapshot.late.install）')
...
// 三、总数：已知事件恰为 85 个（常驻 38 加按需 42 加自监控 5），退役的不计入。
{
  ...
  check(RESIDENT.length === 38 && ONDEMAND.length === 43 && SELFMON.length === 5 && known.length === 86, '清单总数 86（常驻 38、按需 43、自监控 5）')
  check(missing.length === 0, '86 个事件全部落点无缺口' + (missing.length ? ' —— 缺口：' + missing.join('、') : '（命中 ' + hitKnown.length + ' 个）'))
}
