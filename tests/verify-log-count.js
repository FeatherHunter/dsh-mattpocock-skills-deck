// verify-log-count.js —— #494 第三件事：日志门禁之计数（#489 附录第 4 节断言六，#499 自监控 5 条并入，#548 安装执行 1 条并入，#606 按需 2 条并入，#635 按需 1 条并入，#652 按需 1 条并入，#655 按需 1 条并入）。
// 用法：在插件根目录执行 node tests/verify-log-count.js，可独立运行。
// 断言文字：常驻 31 条、按需 26 条、自监控 5 条、总数 62（#22、#34 已退役；#618 增补常驻 #60 与按需 #61，#635 增补按需 #62，#652 增补按需 #63，#655 增补按需 #64）；
// 增删事件必须同步更新附录对照表，否则红。
...
console.log('日志计数门禁（#494/#498/#499/#548/#606/#618/#635/#652/#655：常驻 31、按需 26、自监控 5、总数 62，与附录修订版字面一致）')
...
// 按需 26 条编号（#498 增补 #52、#53、#54、#56，#606 增补 #58、#59，#618 增补 #61，#635 增补 #62，#652 增补 #63，#655 增补 #64）：含 #45，不含已退役。
...
if (appendix) {
  check(appendix.includes('常驻 31 条、按需 26 条、自监控 5 条、总数 62 条'), '附录 counts 字面为常驻 31 条、按需 26 条、自监控 5 条、总数 62 条')
  ...
  check(appendix.includes('2、11、12、15、17、18、19、23、24、25、29、30、37、43、44、45、52、53、54、56、58、59、61、62、63、64'), '附录按需编号清单 26 个（含 45；#498 增补 52、53、54、56；#606 增补 58、59；#618 增补 61；#635 增补 62；#652 增补 63；#655 增补 64）')
...
// 三、总数：已知事件恰为 62 个（常驻 31 加按需 26 加自监控 5），退役的不计入。
{
  ...
  check(RESIDENT.length === 31 && ONDEMAND.length === 26 && SELFMON.length === 5 && known.length === 62, '清单总数 62（常驻 31、按需 26、自监控 5）')
  check(missing.length === 0, '62 个事件全部落点无缺口' + (missing.length ? ' —— 缺口：' + missing.join('、') : '（命中 ' + hitKnown.length + ' 个）'))
}
