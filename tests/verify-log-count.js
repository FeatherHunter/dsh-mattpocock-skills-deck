// verify-log-count.js —— #494 第三件事：日志门禁之计数（#489 附录第 4 节断言六，#499 自监控 5 条并入，#548 安装执行 1 条并入，#606 按需 2 条并入，#635 按需 1 条并入，#652 按需 1 条并入，#655 按需 1 条并入，#663 常驻 1 条并入，#66 按需 1 条并入，#67 按需 1 条并入，#685 常驻 1 条并入，#690 常驻 1 条并入）。
// 用法：在插件根目录执行 node tests/verify-log-count.js，可独立运行。
// 断言文字：常驻 35 条、按需 31 条、自监控 5 条、总数 71（#22、#34、#35 已退役；#618 增补常驻 #60 与按需 #61，#635 增补按需 #62，#652 增补按需 #63，#655 增补按需 #64，#663 增补常驻 #65，2026-09-21 增补按需 #66 chain.stale.drop 与 #67 snapshot.stale.drop；2026-09-22 #685 增补常驻 #68 healthCheck.inject、#683 增补 #69/#70 与按需 #71/#72/#73、#690 增补常驻 #74 issues.page）；
// 增删事件必须同步更新附录对照表，否则红。
...
if (appendix) {
  check(appendix.includes('常驻 35 条、按需 31 条、自监控 5 条、总数 71 条'), '附录 counts 字面为常驻 35 条、按需 31 条、自监控 5 条、总数 71 条')
  ...
  check(appendix.includes('2、11、12、15、17、18、19、23、24、25、29、30、37、43、44、45、52、53、54、56、58、59、61、62、63、64、66、67、71、72、73'), '附录按需编号清单 31 个（不含已退役的 8、22、34、35 等；含 45；#498 增补 52、53、54、56；#606 增补 58、59；#618 增补 61；#635 增补 62；#652 增补 63；#655 增补 64；2026-09-21 增补 66、67；#683 增补 71、72、73）')
...
// 三、总数：已知事件恰为 65 个（常驻 32 加按需 28 加自监控 5），退役的不计入。
{
  ...
  check(RESIDENT.length === 35 && ONDEMAND.length === 31 && SELFMON.length === 5 && known.length === 71, '清单总数 71（常驻 35、按需 31、自监控 5）')
  check(missing.length === 0, '71 个事件全部落点无缺口' + (missing.length ? ' —— 缺口：' + missing.join('、') : '（命中 ' + hitKnown.length + ' 个）'))
}
