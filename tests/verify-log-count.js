// verify-log-count.js —— #494 第三件事：日志门禁之计数（#489 附录第 4 节断言六，#499 自监控 5 条并入，#548 安装执行 1 条并入，#606 按需 2 条并入，#635 按需 1 条并入，#652 按需 1 条并入，#655 按需 1 条并入，#663 常驻 1 条并入，#66 按需 1 条并入，#67 按需 1 条并入）。
// 用法：在插件根目录执行 node tests/verify-log-count.js，可独立运行。
// 断言文字：常驻 31 条、按需 28 条、自监控 5 条、总数 64（#22、#34、#35 已退役；#618 增补常驻 #60 与按需 #61，#635 增补按需 #62，#652 增补按需 #63，#655 增补按需 #64，#663 增补常驻 #65，2026-09-21 增补按需 #66 chain.stale.drop 与 #67 snapshot.stale.drop）；
// 增删事件必须同步更新附录对照表，否则红。
...
console.log('日志计数门禁（#494/#498/#499/#548/#606/#618/#635/#652/#655/#663/#66/#67：常驻 31、按需 28、自监控 5、总数 64，与附录修订版字面一致）')

// 附录对照表里的现行清单（1.3 落定后常驻 27 条，#498 增补 #51 与 #55 成 29 条，#548 增补 #57 成 30 条，#618 增补 #60 成 31 条，
// #663 增补 #65 成 32 条；2026-09-21 #35 settings.save 退役成 31 条；另有 3 条已退役只作追溯）。
...
if (appendix) {
  check(appendix.includes('常驻 31 条、按需 28 条、自监控 5 条、总数 64 条'), '附录 counts 字面为常驻 31 条、按需 28 条、自监控 5 条、总数 64 条')
  check(appendix.includes('1、3、4、5、6、7、8、9、10、13、14、16、20、21、26、27、28、31、32、33、36、38、39、40、41、42、51、55、57、60、65'), '附录常驻编号清单 31 个（不含已退役的 22、34、35，不含 45；#498 增补 51、55，#548 增补 57，#618 增补 60，#663 增补 65）')
  check(appendix.includes('2、11、12、15、17、18、19、23、24、25、29、30、37、43、44、45、52、53、54、56、58、59、61、62、63、64、66、67'), '附录按需编号清单 28 个（不含已退役的 8、22、34、35 等；含 45；#498 增补 52、53、54、56；#606 增补 58、59；#618 增补 61；#635 增补 62；#652 增补 63；#655 增补 64；2026-09-21 增补 66、67）')
...
// 二、源码点名：常驻 31、按需 28、自监控 5 逐个出现（单双引号都算），退役 3 条不许出现。
...
// 三、总数：已知事件恰为 64 个（常驻 31 加按需 28 加自监控 5），退役的不计入。
{
  ...
  check(RESIDENT.length === 31 && ONDEMAND.length === 28 && SELFMON.length === 5 && known.length === 64, '清单总数 64（常驻 31、按需 28、自监控 5）')
  check(missing.length === 0, '64 个事件全部落点无缺口' + (missing.length ? ' —— 缺口：' + missing.join('、') : '（命中 ' + hitKnown.length + ' 个）'))
}
