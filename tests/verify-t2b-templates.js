...
console.log('T1: 默认模板渲染')
{
  ...
  assert.ok(h2.includes('/read .scratch/handoff/20260814-172113.md'), 'handoff2 {file} 注入')
...
console.log('T5: 交接两击一致性（F1 修正）')
{
  ...
  assert.ok(h2.includes('/read .scratch/handoff/交接-20260814-172113.md'), '第二击读自定义文件名')
  // 解析失败兜底 handoffTs + '.md'
