...
const KNOWN = ['snapshot.request', 'snapshot.cache.hit', 'snapshot.cache.miss', 'repo.resolve.tier', 'gh.exec', 'gh.timeout', 'gh.resolve.fail', 'graphql.fallback', 'issues.fallback', 'snapshot.built', 'probe.eval', 'panelSync.eval', 'panelSync.dirty', 'registry.select', 'registry.stub', 'detection.detect', 'workspaceStore.hit', 'chain.cache.hit', 'chain.predicate', 'skill.probe', 'skill.pending.cap', 'workspaceKey.canonical', 'workspaceRoot.resolve', 'platform.resolve', 'naming.sweep', 'host.call', 'host.call.fail', 'snapshot.hydrate', 'snapshot.fanout', 'dedup.hit', 'backend.switch', 'naming.guard', 'naming.lock', 'settings.save', 'panel.open', 'panel.render', 'statusbar.hydrate', 'statusbar.fallback', 'dock.rehydrate', 'storage.fail', 'chain.derive.error', 'fallback.chain', 'error.normalize', 'timer.schedule', 'privacy.scrub', 'exec.run', 'host.dispatch.error', 'log.persist.fail', 'log.forward.summary', 'log.switch.watchdog', 'log.export.fail']
