...
console.log('')
console.log('-- 5) gh 登录黄条 inject-prompt 替换 openUrl --')
...
check(checksTab.includes("promptText('ghAuthLogin')") || checksTab.includes('ghAuthLogin'), 'ChecksTab 使用 ghAuthLogin')
...
check(statusBar.includes("promptText('ghAuthLogin')") || statusBar.includes('ghAuthLogin'), 'StatusBar 使用 ghAuthLogin')
...
check(host.includes("'prompt:ghAuthLogin'") || host.includes('prompt:ghAuthLogin'), 'host hint 已改为 prompt:ghAuthLogin')
