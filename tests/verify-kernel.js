...
const MODULES = [
  ...
  { name: 'router', exports: ['openInNativeRight', 'openInSidebar', 'openPanel', 'togglePanel', 'ensureSidebarTab', 'afterPanelOpened', 'repoStr', 'startText', 'newWayfinderText', 'newBugWayfinderText'] },
