> **归档说明（2026-09-16 生效）**：本文件原在分支 `research/536-dsh-im-recheck` 的 `research/536-dsh-im-recheck.md`，归档时该分支顶端提交是 `1a264d3813`。2026-09-16 随分支清理并进本仓库主线，正文一字未动，只在本行之上加了这段说明。
