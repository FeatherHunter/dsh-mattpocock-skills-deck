> **归档说明（2026-09-16 生效）**：本文件原在分支 `research/reuse-inventory` 的 `_research/reuse-inventory.md`，归档时该分支顶端提交是 `0a506bea2d`。2026-09-16 随分支清理并进本仓库主线；正文只有第 10 行与第 318 行两处自述旧位置的路径改成了新位置，其余一字未动。
...
> 落盘: `research/374-reuse-inventory.md`
> 日期: 2026-09-01
...
- 本文件: `research/374-reuse-inventory.md`（归档前在分支 `research/reuse-inventory`）
